...
export const FooterLinksCol = ({footerLinkBlock}:{footerLinkBlock: footerLinksType}) => {
  ...
  return ( 
    <VStack w="full"> 
     ...
     >
       <ListItem>
            <Heading as="h5" sx={{ marginBottom: "10px", fontSize:"20px", fontWeight: "500" }}>
                {title}
            </Heading>
        </ListItem>
        {links.map(link => (<ListItem key={link.name}>
