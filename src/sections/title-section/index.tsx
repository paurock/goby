import { Flex, Container, VStack, Box, Icon } from "@chakra-ui/react";
  ...
  return (
    <Flex maxH="36px" justify="start" gap="32px">
      <motion.div
        ...
        whileHover={{ borderBottom: "2px solid #6334B1" }}
      ...
      >
        <Icon
          ...
          w="25px"
          h="25px"
          stroke={isHover === 1 ? "#6334B1" : "#010504"}
        />
        Collateral
      </motion.div>
      <motion.div
      ...
      >
        <Icon
          ...
          w="25px"
          h="25px"
          stroke={isHover === 2 ? "#6334B1" : "#010504"}
        />
        Loans
      </motion.div>
      <motion.div
      ...
      >
        <Icon
          ...
          w="25px"
          h="25px"
          stroke={isHover === 3 ? "#6334B1" : "#010504"}
        />
        My offers
      </motion.div>
    </Flex>
...
const TitleSection = () => {
  const { text, purpleTextHovered, collateral, loans, flag } = useAssets();
    ...
    >
      ...
      >
        ...
        <Tabs
          ...
          text={text}
          purpleTextHovered={purpleTextHovered}
          flag={flag}
        />
      </VFlex>
    </Container>
